            ...
            <div class="page-section">
                ...
                <div class="card card-fluid bg-light">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <h1 class="page-title"> Manage Ingredients</h1>
                        <a href="{{ route('admin.add.ingredient') }}" class="btn btn-primary ">Add New </a>
                    </div>
                    @php
                        $i = 1;
                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img class="img rounded" width="100"
                                                src="{{ asset('front/assets/images/ingredients/' . $data->image) }}"
                                        ...
                                        <td class="m-3">
                                            <div>
                                                <a href="{{ route('admin.edit.ingredient', $data->id) }}"
                                                    class="btn btn-info">Edit</a>
                                                 <a href="{{ route('admin.delete.ingredient', $data->id) }}" class="btn btn-danger"
