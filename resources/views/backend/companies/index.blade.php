        ...
        <div class="page-inner">
            ...
            <header class="page-title-bar">
                {{-- <div class="d-flex justify-content-between">
                    <h1 class="page-title"> Manage Company Sliders </h1>
            ...
            <div class="page-section">
                ...
                <div class="card card-fluid bg-light">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <h1 class="page-title">Manage Company logos</h1>
                        <a href="{{ route('admin.add.company-logo') }}" class="btn btn-primary ">Add New</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img class="img rounded" width="100" height="100"
                                                src="{{ asset('front/assets/images/find-uzi/' . $data->company_logo) }}"
                                                alt="{{ Str::limit($data->site_name, 20) }}">

                                        </td>
                                        <td class="m-3">
                                            <div>
                                                <a href="{{ route('admin.edit.company-logo', $data->id) }}"
                                                    class="btn btn-info">Edit</a>
                                                <a href="{{ route('admin.delete.company-logo', $data->id) }}"
